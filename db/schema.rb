...
ActiveRecord::Schema[8.0].define(version: 2025_08_15_044216) do
  ...
  add_foreign_key "cart_items", "admin_users", column: "user_id"
  add_foreign_key "cart_items", "products"
  add_foreign_key "order_items", "orders"
  add_foreign_key "order_items", "products"
  add_foreign_key "orders", "admin_users", column: "user_id"
